...
import TypeFilterMethod from "../Filters/FilterBox/TypeFilterMethod";
...
const SearchBox = () => {
  ...
  const filteredPokemons = allPokemons.filter(x => x).filter((pokemon) => {
  ...
  return (
    <div>
      <div className="filter-and-search">
        ...
        {width > 900 && <><GenderFilterMethod />
        <TypeFilterMethod /></>}
        {width < 900 && <><FilterIcon/></>}        
      </div>
